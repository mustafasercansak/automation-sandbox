...
timeline
    ...
    Phase 3 : Next Horizon : Persistent Locator Repository JSON : Playwright Web Adapter : NuGet Package Release
```
...
graph LR
    subgraph PhaseA [Phase A: Core Hardening]
        ...
        M3[M3: Persistent Locator Repository - 📋 Next]
        M1 --> M2 --> M3
    end
...
timeline
    ...
    Phase 3 : Gelecek Ufku : Kalıcı Lokasyon Deposu JSON : Playwright Web Bağlayıcısı : NuGet Paketi Yayınlama
```
...
graph LR
    subgraph PhaseA [Aşama A: Çekirdek Güçlendirme]
        ...
        M3[M3: Kalıcı Lokasyon Deposu - 📋 Sıradaki]
        M1 --> M2 --> M3
    end
