...
{
    /// <summary>Mutable shortlist and review thresholds for desktop intent matching.</summary>
    public sealed class IntentDesktopExplorationOptions
    {
        ...
        /// <summary>Minimum semantic overlap score required before a desktop candidate is accepted without review (issue #5). Calibrated to 0.01: demands at least one non-zero token match while accommodating single-token matches (e.g. &quot;btnSave&quot; with semantic ~0.043 against multi-field intent targets). Re-evaluated with benchmark dataset under #15.</summary>
