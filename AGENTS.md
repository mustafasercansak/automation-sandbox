...
- `Directory.Build.props` carries shared NuGet pack metadata (Authors, MIT license expression, version `0.2.0-beta.3`, `Deterministic` builds). Packable by default; demo apps, the sample, and the test project opt out with `IsPackable=false`.
